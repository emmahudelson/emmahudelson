...
- [ ] VALIDATING-6 — Delete "elsewhere" footer block (footer) — Remove the "elsewhere" heading and everything beneath it from the global footer. — PR https://github.com/emmahudelson/emmahudelson/pull/6
