...
- [ ] VALIDATING-4 — Tone down beige in tokens.css (site-wide) — Adjust `--paper` and any warm-cream values in css/tokens.css to a cleaner, less warm, less sepia-toned background. Cooler/closer-to-white cream, not "old timey King's Island photo." — PR https://github.com/emmahudelson/emmahudelson/pull/4
