...
- [ ] VALIDATING-5 — Delete "Indianapolis, IN" from footer (footer) — Remove the Indianapolis, IN line from the global footer. — PR https://github.com/emmahudelson/emmahudelson/pull/5
