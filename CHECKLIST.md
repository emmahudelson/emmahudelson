...
- [ ] VALIDATING-8 — Footer: hide on landing page, add (c)2026 elsewhere (footer + landing) — No footer on the homepage. On every other page, add "(c)2026" beneath the three-asterisk pyramid. — PR https://github.com/emmahudelson/emmahudelson/pull/8
